# Lifter Profile Examples

Browse example lifter profiles from simple to comprehensive.

## minimal.json

The smallest valid lifter profile — just an export timestamp and one exercise with one rep max.
...
A comprehensive lifter profile with height, bodyweight history, multiple exercises, rep maxes, estimated 1RMs, volume PRs, duration PRs, and normalized scores.
...
A lifter profile using pounds and inches.
...
Track lifter physical data:
- **height**: Height with unit (cm or in)
- **bodyweight**: Current bodyweight with unit and optional date
- **bodyweightHistory**: Historical bodyweight entries for tracking over time
...
See all lifter profile examples in the [GitHub repository](https://github.com/radupana/openweight/tree/main/examples/lifter-profiles).
